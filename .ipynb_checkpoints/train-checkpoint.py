...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    #optimizer = smart_optimizer(model, opt.optimizer, 0.002,hyp['momentum'], 0)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-reslc.yaml', help='model.yaml path')
